export function rps(args) {
  ...
  switch (userInput) {
    case undefined:
      ...
      const resultNill = (userInput === opponentChoice)
        ? 'tie'
        : (
      ...
      console.log(`{"player":"${userInput}","opponent":"${opponentChoice}","result":"${resultNill}"}`);
      break;
      break;
    case '-h':
    case '--help':
...
export function rpsls(args) {
  ...
  switch (input) {
    case undefined:
      input = choices[Math.floor(Math.random() * choices.length)];
      const resultNill =
      ...
      console.log(`{"player":"${input}","opponent":"${computerChoice}","result":"${resultNill}"}`);
      break;
    case '-r':
    case '--rules':
      console.log(rules);
